        ...
        <div className="text-center max-w-md mx-auto px-4 md:px-6">
          ...
          >
            <div className="relative">
              ...
              <div className="relative p-6 md:p-8 bg-gradient-to-br from-accent-50 to-accent-100 dark:from-accent-900/30 dark:to-accent-800/20 rounded-2xl md:rounded-3xl">
